...
var require_leaflet_providers = __commonJS({
  "node_modules/leaflet-providers/leaflet-providers.js"(exports, module) {
    (function(root, factory) {
      ...
      "use strict";
      L2.TileLayer.Provider = L2.TileLayer.extend({
        initialize: function(arg, options) {
          var providers = L2.TileLayer.Provider.providers;
          var parts = arg.split(".");
          ...
          if (variantName && "variants" in providers[providerName]) {
            ...
            provider = {
              ...
              options: L2.Util.extend({}, provider.options, variantOptions)
            };
          }
          ...
          var layerOpts = L2.Util.extend({}, provider.options, options);
          L2.TileLayer.prototype.initialize.call(this, provider.url, layerOpts);
        }
      });
      L2.TileLayer.Provider.providers = {
        OpenStreetMap: {
        ...
        Stadia: {
          ...
          variants: {
            ...
            AlidadeSatellite: {
              options: {
                attribution: '&copy; CNES, Distribution Airbus DS, © Airbus DS, © PlanetObserver (Contains Copernicus Data) | &copy; <a href="https://www.stadiamaps.com/" target="_blank">Stadia Maps</a> &copy; <a href="https://openmaptiles.org/" target="_blank">OpenMapTiles</a> {attribution.OpenStreetMap}',
        ...
        HERE: {
          ...
          // replacing app-id with apikey
          options: {
            attribution: "Map &copy; 1987-" + (/* @__PURE__ */ new Date()).getFullYear() + ' <a href="http://platform.here.com">HERE</a>',
            subdomains: "1234",
            mapID: "newest",
            apiKey: "<insert your apiKey here>",
            // switching from appid and appcode to apikey
            base: "base",
            variant: "explore.day",
            maxZoom: 20,
            type: "maptile",
      ...
      L2.tileLayer.provider = function(provider, options) {
        return new L2.TileLayer.Provider(provider, options);
      };
      return L2;
    });
  }
});
export default require_leaflet_providers();
//# sourceMappingURL=leaflet-providers.js.map
