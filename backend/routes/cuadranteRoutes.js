...
// POST /api/cuadrantes/importar-geojson
...
// ─── Rutas PATCH con segmento fijo — deben ir ANTES de /:id ──────────────────

// PATCH /api/cuadrantes/barrio/:barrio/color
// ⚠️ Si esta ruta va después de /:id o /:id/barrio, Express interpreta
//    "barrio" como :id y la request llega al handler equivocado (500).
...
// PATCH /api/cuadrantes/:id/barrio
